...
/plugin install qualitative-outcome@evaluator-tools
```
...
| **qualitative-outcome** | 보도자료(.hwp/.hwpx)를 「정성성과 양식」 항목대로 정리해 한글(.hwpx)로 생성 (보도자료에 없는 정보는 공란 유지) |
